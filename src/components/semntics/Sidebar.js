...
function Sidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <Transition
      ...
      className="bg-[#ffff] w-[268px] h-full space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform lg:relative lg:translate-x-0 z-50">
      {/* Sidebar content */}
      <div>
        ...
        {/* Links */}
        <div
        style={{...(location?.pathname?.split("/")[1] === ""? {backgroundColor:"#CFCFCF", borderRadius:"5px",padding:"8px 0"}:{})}}
              ...
              <Disclosure.Panel className="bg-[#ffff] text-custom-16 rounded-md px-4 py-2">
                <ul className="list-disc list-inside">
                  ...
                  <li
                    ...
                    className="cursor-pointer text-[#909294] hover:text-[#E88B13]"
                  >
                    Category
                  </li>
                </ul>
